...
import { DelContract_type, GetContract_type, GetOneContract_type, PatchContract_type, PostContract_type } from "../controllers/Contract_types.controller.js";

const Contract_typesRouter=Router()

Contract_typesRouter.get("", GetContract_type)
Contract_typesRouter.get("/:id", GetOneContract_type)
